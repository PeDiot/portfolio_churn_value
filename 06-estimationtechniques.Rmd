...
Note that a more in-depth visualisation of those 10 principal components can be found in figures \@ref(fig:mcacontrib14), \@ref(fig:mcacontrib58) and \@ref(fig:mcacontrib910) in the appendix. This charts depict the percent contribution of each variable's categories to the principal axes, which is helpful to have a better undertsanding of MCA results.
