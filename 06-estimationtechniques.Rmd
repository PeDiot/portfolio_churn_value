...
load(file = paste0(backup, "portVal_discount_rate.RData"))
...
```{r custrawvaldens, fig.cap="Customer Lifetime Raw Value depending on discount rate"}
knitr::include_graphics(path = "./imgs/clrv_discount_rate.png")
```
