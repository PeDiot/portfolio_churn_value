...
```{r mcacontrib14, fig.cap="MCA -  Categories contribution to axes 1 to 4"}
knitr::include_graphics(path = "./imgs/mca_contrib_1_4.png")
```

```{r mcacontrib58, fig.cap="MCA -  Categories contribution to axes 5 to 8"}
knitr::include_graphics(path = "./imgs/mca_contrib_5_8.png")
```

```{r mcacontrib910, fig.cap="MCA -  Categories contribution to axes 9 and 10"}
knitr::include_graphics(path = "./imgs/mca_contrib_9_10.png")
```
...
```{r clusterplots, fig.cap="Cluster visualisation onto MCA axes"}
...
```{r}
load(file = paste0(backup_path, "clustering/parangons_dat.Rdata"))
```

<center><b>Data related to cluster 1's parangons</b></center>
...
<center><b>Data related to cluster 2's parangons</b></center>
...
<center><b>Data related to cluster 3's parangons</b></center>
