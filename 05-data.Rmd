...
```{r cltvchurn, fig.cap="Customer lifetime value depending on churn status", out.height="300pt", out.width="450pt"}
...
```{r churndur, fig.cap="Tenure months depending on churn status", out.height="300pt", out.width="500pt"}
